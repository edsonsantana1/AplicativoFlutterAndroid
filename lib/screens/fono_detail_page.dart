...
class FonoDetailPage extends StatefulWidget {
  const FonoDetailPage({super.key});

  @override
  _FonoDetailPageState createState() => _FonoDetailPageState();
}

class _FonoDetailPageState extends State<FonoDetailPage> {
    ...
    setState(() {
      ...
      switch (index) {
        ...
        case 2:
          Navigator.pushReplacement(
            context,
            MaterialPageRoute(builder: (context) => ProfilePage()), // Removido o const
          );
          break;
      }
    });
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Center(child: Text('Fonoaudiólogo')),
      ),
      body: Container(
