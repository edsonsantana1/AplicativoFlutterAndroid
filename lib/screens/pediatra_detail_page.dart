...
class PediatraDetailPage extends StatefulWidget {
  const PediatraDetailPage({super.key});

  @override
  _PediatraDetailPageState createState() => _PediatraDetailPageState();
}

class _PediatraDetailPageState extends State<PediatraDetailPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Center(child: Text('Pediatra')),
      ),
      body: Container(
